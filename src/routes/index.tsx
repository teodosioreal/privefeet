...
const rawPosts: Array<Omit<Post, "image" | "avatar">> = [
  { name: "Lunahype", handle: "@lunahype", time: "há 4 min", tag: "Pets", text: "Pés de veludo", price: "R$ 31,84", likes: "2.418", comments: "184" },
  { name: "Marcellyfans", handle: "@marcellyfans", time: "há 12 min", tag: "Paisagem", text: "Velvet steps", price: "R$ 47,84", likes: "5.902", comments: "421" },
  { name: "Beladreams", handle: "@beladreams", time: "há 25 min", tag: "Pets", text: "Pasos de seda", price: "R$ 39,84", likes: "3.117", comments: "256" },
  { name: "Jujubacore", handle: "@jujubacore", time: "há 45 min", tag: "Aéreas", text: "خطى الحرير", price: "R$ 63,84", likes: "8.340", comments: "612" },
  { name: "Anacrush", handle: "@anacrush", time: "há 1 h", tag: "Arquitetura", text: "Toque suave", price: "R$ 56,00", likes: "1.902", comments: "97" },
  { name: "Melzinhaofc", handle: "@melzinhaofc", time: "há 1 h", tag: "Natureza", text: "Soft touch", price: "R$ 36,00", likes: "4.221", comments: "310" },
  { name: "Claramood", handle: "@claramood", time: "há 2 h", tag: "Viagem", text: "Encanto sutil", price: "R$ 79,84", likes: "6.780", comments: "524" },
  { name: "Vickylovers", handle: "@vickylovers", time: "há 2 h", tag: "Pets", text: "سحر خفي", price: "R$ 28,80", likes: "9.110", comments: "703" },
  { name: "Manuforever", handle: "@manuforever", time: "há 3 h", tag: "Paisagem", text: "Charme nos detalhes", price: "R$ 44,64", likes: "2.980", comments: "142" },
  { name: "Lalaflow", handle: "@lalaflow", time: "há 4 h", tag: "Pets", text: "Barefoot dreams", price: "R$ 49,60", likes: "3.640", comments: "221" },
  { name: "Dudaglow", handle: "@dudaglow", time: "há 5 h", tag: "Viagem", text: "Magia en cada paso", price: "R$ 72,00", likes: "7.412", comments: "489" },
  { name: "Giovannavibes", handle: "@giovannavibes", time: "há 6 h", tag: "Arquitetura", text: "أنوثة ناعمة", price: "R$ 40,00", likes: "1.455", comments: "88" },
  { name: "Majuverse", handle: "@majuverse", time: "há 8 h", tag: "Natureza", text: "Pés descalços, alma livre", price: "R$ 32,00", likes: "5.130", comments: "367" },
  { name: "Sofiacrush", handle: "@sofiacrush", time: "há 9 h", tag: "Pets", text: "Serene beauty", price: "R$ 46,24", likes: "4.008", comments: "295" },
  { name: "Isaacore", handle: "@isaacore", time: "há 11 h", tag: "Paisagem", text: "Belleza oculta", price: "R$ 83,20", likes: "10.240", comments: "914" },
  { name: "Biazone", handle: "@biazone", time: "há 13 h", tag: "Viagem", text: "خطوات رقيقة", price: "R$ 53,60", likes: "2.211", comments: "154" },
  { name: "Carolvibes", handle: "@carolvibes", time: "há 16 h", tag: "Pets", text: "Elegância natural", price: "R$ 35,04", likes: "6.045", comments: "412" },
  { name: "Ninahouse", handle: "@ninahouse", time: "há 20 h", tag: "Natureza", text: "Gentle stride", price: "R$ 59,20", likes: "3.874", comments: "268" },
];
